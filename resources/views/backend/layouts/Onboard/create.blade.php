...
@section('title', 'Onboard Create')

@section('content')
{{-- PAGE-HEADER --}}
<div class="page-header">
    <div>
        <h1 class="page-title">Add Onboard</h1>
    </div>
</div>
{{-- PAGE-HEADER --}}
...
<div class="row">
    <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
        <div class="card box-shadow-0">
            <div class="card-body">
                <form method="POST" action="{{ route('onboard.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('old') is-invalid @enderror"
                                    name="old" placeholder="Enter your age" id="old">
                                @error('old')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('find_us') is-invalid @enderror"
                                    name="find_us" placeholder="e.g., Social Media, Friend" id="find_us">
                                @error('find_us')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('main_goal') is-invalid @enderror"
                                    name="main_goal" placeholder="Enter your main goal" id="main_goal">
                                @error('main_goal')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
