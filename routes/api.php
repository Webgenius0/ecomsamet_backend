...
Route::middleware(['auth:api', 'role:hairdresser'])->group(function () {
    ...
    Route::put('/notification/markall', [HairDresserNotificationController::class, 'markAllRead']);
    Route::put('/notification/read/{id}', [HairDresserNotificationController::class, 'markSingleRead']);
});
